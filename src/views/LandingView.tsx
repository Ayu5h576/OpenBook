    ...
    <div className="w-full bg-[var(--bg-ivory)] text-[var(--ink)] min-h-screen">
      ...
      <header className="absolute top-0 left-0 right-0 p-6 md:px-12 flex justify-between items-center z-10 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() => onNavigate('auth')}
            className="px-5 py-2 rounded-full bg-[var(--ink)] text-[var(--bg-ivory)] text-sm font-bold hover:bg-[var(--ink-hover)] transition-colors shadow-sm hidden sm:block"
          >
            Create Free Account
          </button>
        </div>
      ...
      */}
      ...
      <section className="relative px-6 md:px-12 pt-32 pb-20 md:pb-28 max-w-7xl mx-auto overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[var(--bg-beige)] text-[var(--accent)] text-xs font-semibold shadow-warm-sm">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <button
                onClick={() => onNavigate('auth')}
                className="flex items-center gap-3 px-8 py-4 rounded-full bg-[var(--ink)] text-[var(--bg-ivory)] font-bold text-sm hover:bg-[var(--ink-hover)] transition-all shadow-warm-lg"
              >
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="relative group cursor-pointer" onClick={() => onNavigate('auth')}>
              ...
              <div className="absolute -bottom-6 -left-6 bg-[var(--white)] border border-[var(--border-light)] rounded-2xl p-4 shadow-warm-lg max-w-xs">
                <span className="text-[10px] uppercase font-bold text-[var(--accent)] tracking-wider">Spotlight Volume</span>
      ...
      <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-xs uppercase font-bold text-[var(--accent)] tracking-wider">Editor's Selection</span>
      ...
      {/* Footer */}
      <footer className="bg-[var(--panel-dark)] text-white py-12 px-6 md:px-12 border-t border-[#333333]">
