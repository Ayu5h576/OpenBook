    ...
    <div className="w-full bg-[var(--white)] border border-[var(--border-light)] rounded-3xl p-6 md:p-10 shadow-warm-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        <div className="bg-[var(--bg-ivory)] border border-[var(--border-light)] rounded-2xl p-6">
          <div className="w-10 h-10 rounded-xl bg-[var(--ink)] text-[var(--bg-ivory)] flex items-center justify-center mb-4">
            <Brain className="w-5 h-5" />
          </div>
          <span className="text-xs uppercase font-semibold text-[var(--muted)] tracking-wider">Prose Signature</span>
          <h3 className="font-serif-title text-2xl font-bold text-[var(--ink)] my-1">
      ...
      <div className="bg-[var(--bg-ivory)] rounded-2xl p-6 border border-[var(--border-light)]">
        <h4 className="font-serif-title text-xl font-bold text-[var(--ink)] mb-4">Genre Affinity Strands</h4>
